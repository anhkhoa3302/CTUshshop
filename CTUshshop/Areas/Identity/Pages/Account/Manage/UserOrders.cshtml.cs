...
namespace CTUshshop.Areas.Identity.Pages.Account.Manage
{
    public class UserOrdersModel : PageModel
    {
        ...
        public UserOrdersModel(UserManager<ApplicationUser> userManager, shshopContext context)
        {
        ...
        private async Task LoadAsync(ApplicationUser user, int pg)
        {
            ...
            var shshopdbContext = await _context.Order.Where(m => m.UserId == UserId).ToListAsync();
